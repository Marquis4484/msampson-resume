   ...
   return (
      ...
      >
         <div className="flex flex-col items-center phone:text-[28px] tablet:text-[36px] laptop:text-[50px] flex-1">
            ...
            <hr className="phone:w-[260px] tablet:w-[350px]  laptop:w-[450px] desktop:w-[530px] laptop:my-[30px]  border-[1.5px] border-[#000000]" />
            <span className="font-bold phone:text-[26px] tablet:text-[35px] laptop:py-[30px] laptop:text-[52px] py-[20px]">
               Software Engineer
            </span>
            <p className=" text-center py-[5px] laptop:my-[40px]">
         ...
         <div className="flex flex-col items-center  tablet:text-[33px] phone:text-[28px] laptop:text-[45px] flex-1">
            ...
            <p className=" py-[5px] px-[30px] text-center laptop:py-[30px]">
               Hit This Button!
            </p>
            <button className="bg-[#D9D9D9] rounded-full h-[70px] w-[70px] p-2 hover:">
               <ArrowPathIcon />
            </button>
         </div>
      </div>
